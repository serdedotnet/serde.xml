...
partial class XmlTests
{
    ...
    {
        sealed partial class _DeObj : Serde.IDeserialize<Serde.Xml.Test.XmlTests.IntArrayStruct>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Xml.Test.XmlTests.IntArrayStruct.s_serdeInfo;

            Serde.Xml.Test.XmlTests.IntArrayStruct Serde.IDeserialize<Serde.Xml.Test.XmlTests.IntArrayStruct>.Deserialize(IDeserializer deserializer)
            {
                ...
                var newType = new Serde.Xml.Test.XmlTests.IntArrayStruct() {

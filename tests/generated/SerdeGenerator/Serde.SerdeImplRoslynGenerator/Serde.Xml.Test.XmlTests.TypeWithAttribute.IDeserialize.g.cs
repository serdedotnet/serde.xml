...
partial class XmlTests
{
    ...
    {
        sealed partial class _DeObj : Serde.IDeserialize<Serde.Xml.Test.XmlTests.TypeWithAttribute>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Xml.Test.XmlTests.TypeWithAttribute.s_serdeInfo;

            Serde.Xml.Test.XmlTests.TypeWithAttribute Serde.IDeserialize<Serde.Xml.Test.XmlTests.TypeWithAttribute>.Deserialize(IDeserializer deserializer)
            {
                ...
                var newType = new Serde.Xml.Test.XmlTests.TypeWithAttribute() {
                    Name = _l_name,
                    Value = _l_value,
                };
